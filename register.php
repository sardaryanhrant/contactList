		...
		<div class="col-md-5 login-sec">
		    ...
		    <form class="register-form">
			  	...
			  	<div class="form-group">
				    ...
				    <input id="email" required="required" name="email" type="text" class="form-control" placeholder="Email">
			  	...
			  	<div class="form-group">
				    ...
				    <input id="confirmPassword" required="required" name="confirmPassword" type="password" class="form-control" placeholder="Confirm Password">
